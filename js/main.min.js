...
var initReviewsSwiper = function initReviewsSwiper() {
  var reviewSwiper = new _swiper.default('.reviews-swiper', {
    spaceBetween: 20,
    grabCursor: true,
    autoHeight: false,
    loop: false,
...
},{"./vendor/swiper":15}],2:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.initTrainersSwiper = void 0;
var _swiper = _interopRequireDefault(require("./vendor/swiper"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var visibleSlides = [];
var getVisibleSlides = function getVisibleSlides() {
  visibleSlides = document.querySelectorAll('.slide-visible');
};
var addTabIndex = function addTabIndex(arr) {
  arr.forEach(function (item) {
    return item.firstElementChild.setAttribute('tabindex', 0);
  });
};
var clearTabIndex = function clearTabIndex(actualSwiper) {
  actualSwiper.slides.filter(function (item) {
    return item.firstElementChild.hasAttribute('tabindex');
  }).forEach(function (item) {
    return item.firstElementChild.removeAttribute('tabindex');
  });
};
var onEventTabReassign = function onEventTabReassign(actualSwiper) {
  clearTabIndex(actualSwiper);
  getVisibleSlides();
  addTabIndex(visibleSlides);
};
var initTrainersSwiper = function initTrainersSwiper() {
  var trainersSwiper = new _swiper.default('.trainers-swiper', {
    slidesPerView: 1,
    spaceBetween: 10,
    breakpoints: {
      768: {
  ...
  trainersSwiper.on('transitionEnd', function () {
    return onEventTabReassign(trainersSwiper);
  });
  trainersSwiper.on('breakpoint', function () {
    return onEventTabReassign(trainersSwiper);
  });
};
exports.initTrainersSwiper = initTrainersSwiper;

},{"./vendor/swiper":15}],3:[function(require,module,exports){
"use strict";

var _iosVhFix = require("./utils/ios-vh-fix");
var _form = require("./modules/form-validate/form");
var _video = require("./video");
var _initTabs = require("./vendor/tabs/init-tabs");
var _initAccordion = require("./vendor/accordion/init-accordion");
var _initTrainersSwiper = require("./init-trainers-swiper");
var _initReviewsSwiper = require("./init-reviews-swiper");
// ---------------------------------
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  (0, _video.initVideo)();
  (0, _initTrainersSwiper.initTrainersSwiper)();
  (0, _initReviewsSwiper.initReviewsSwiper)();
...
},{"./init-reviews-swiper":1,"./init-trainers-swiper":2,"./modules/form-validate/form":5,"./utils/ios-vh-fix":12,"./vendor/accordion/init-accordion":14,"./vendor/tabs/init-tabs":16,"./video":18}],4:[function(require,module,exports){
"use strict";
...
},{"./accordions":13}],15:[function(require,module,exports){
...
var videoButton = document.querySelector('[data-bem = "gym__video-button"]');
var videoContent = document.querySelector('[data-bem = "gym__video-content"]');
var videoPoster = document.querySelector('[data-bem = "gym__video-poster"]');
var videoPlayer = videoContent.querySelector('iframe');
var videoSrc = videoPlayer.getAttribute('src');
var videoButtonOnClick = function videoButtonOnClick() {
